...
#define INTEGRAL_WINDUP_MIN                                                                        \
    -1000 // Anti-windup integral minimum (increased for more integral accumulation)
#define INTEGRAL_WINDUP_MAX                                                                        \
    1000 // Anti-windup integral maximum (increased for more integral accumulation)
