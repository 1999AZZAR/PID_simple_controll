...
// Hardware Pins (ESP32-C3 SuperMini) — same as control/
#define RPM_INPUT_PIN         0   // GPIO 0 (Requires Voltage Divider 5V->3.3V)
#define PWM_OUTPUT_PIN        1   // GPIO 1
#define POT_ENABLE_PIN        3   // Pull LOW to enable sensitivity trim (INPUT_PULLUP)
#define POT_SENSITIVITY_PIN   2   // GPIO 2 (ADC1_CH2)
