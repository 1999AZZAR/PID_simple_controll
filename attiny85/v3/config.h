...
// Same structure/pins as v1 (proven to drive the motor). v3 = v2 structure +
// failsafe improvements (see v3.ino).

// Clock: 8 MHz internal (lfuse 0xE2) is the standard; comment out the
// 16 MHz line below if you fuse the chip to 0xE1.
...
// v3 failsafe: if no sensor pulse for this long while RUNNING at speed,
// the controller cuts power to protect against a stalled motor or a dead
// hall sensor. 150 ms is ~14x the target pulse period (10.4 ms).
